"""
Flat-FRL: CA-PFedAvg + ISL-Gossip (main proposal, flat-state PPO, FedPer).
"""
...
LOG_EVERY = 100; SAVE_DIR = Path("results/flat_frl")
...
def run():
    ...
    with open(SAVE_DIR / "metrics.json", "w") as f: json.dump(metrics, f)
    print("Flat-FRL (CA-PFedAvg+ISL-Gossip) done. Saved to", SAVE_DIR)
