"""CA-PFedAvg only — contact-duration weighted FedAvg + relay expansion, NO ISL-Gossip."""
...
LOG_EVERY = 100; SAVE_DIR = Path("results/capfedavg")
...
def run():
    ...
    with open(SAVE_DIR / "metrics.json", "w") as f: json.dump(metrics, f)
    print("CA-PFedAvg done. Saved to", SAVE_DIR)
